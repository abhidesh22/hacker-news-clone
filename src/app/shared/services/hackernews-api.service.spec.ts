...
import { MockHackernewsApiService } from './../../../testing/mocks/mock-hackernews-api.service';
...
describe('HackernewsApiService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [{ provide: HackernewsApiService, useClass: MockHackernewsApiService }],
    });
